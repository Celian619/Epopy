...
public class SnakeGame extends AbstractGameMenu {
	...
	public void render() {
		...
		for (mouse m : posMouse) {
			Location loc = m.loc;
			if (m.walk < 10)
				ComponentsHelper.renderTexture(Textures.GAME_SNAKE_SOURIS, (int) (cubeX * loc.getX() - 60), (int) (cubeY * loc.getY() - 65 / 2), 120, 65, loc.getDirection());
			else
				ComponentsHelper.renderTexture(Textures.GAME_SNAKE_SOURIS2, (int) (cubeX * loc.getX() - 60), (int) (cubeY * loc.getY() - 65 / 2), 120, 65, loc.getDirection());
