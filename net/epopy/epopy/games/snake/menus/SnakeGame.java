...
public class SnakeGame extends AbstractGameMenu {
	...
	public void render() {
		...
		for (mouse m : posMouse) {
			Location loc = m.loc;
			if (m.walk < 5)
				ComponentsHelper.renderTexture(Textures.GAME_SNAKE_FOOD, (int) (cubeX * loc.getX() - 60), (int) (cubeY * loc.getY() - 17), 120, 34, loc.getDirection(), true);
			else if (m.walk < 10 || m.walk > 15)
				ComponentsHelper.renderTexture(Textures.GAME_SNAKE_FOOD2, (int) (cubeX * loc.getX() - 60), (int) (cubeY * loc.getY() - 17), 120, 34, loc.getDirection(), true);
			else
				ComponentsHelper.renderTexture(Textures.GAME_SNAKE_FOOD3, (int) (cubeX * loc.getX() - 60), (int) (cubeY * loc.getY() - 17), 120, 34, loc.getDirection(), true);
