...
public class SpeedRunGame extends AbstractGameMenu {
	...
	private boolean sneak, pauseScreen, addStats;
	private int playerWalk, playerSneak, height, propulsion, newRobot;
	private double level, decors;
