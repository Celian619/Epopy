	...
	public void render() {
		...
		if (!pause.isFinish()) {
			...
			if (pause.getTimePauseTotal() == 5) {
				...
				drawText("Jump", x, y + 10, PositionWidth.MILIEU, PositionHeight.HAUT, 25, white);
				drawText("Sneak", x, y + 140, PositionWidth.MILIEU, PositionHeight.HAUT, 25, white);

				drawText(Input.getKeyName(SpeedRunOptions.KEY_JUMP), x + 16 - 30, y + 37, 50, white);
				drawText(Input.getKeyName(SpeedRunOptions.KEY_SNEAK), x + 16 - 30, y + 130 + 37, 50, white);
				
				drawText("OBJECTIF", 660, 495, PositionWidth.GAUCHE, PositionHeight.HAUT, 30, orange);
				drawText("Tenir plus de", 710, 600, PositionWidth.MILIEU, PositionHeight.HAUT, 25, grey);
				drawText("2 minutes", 710, 630, PositionWidth.MILIEU, PositionHeight.HAUT, 25, grey);
