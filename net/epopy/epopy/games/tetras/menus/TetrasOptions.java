...
public class TetrasOptions extends AbstractGameMenu {
	...
	public static int KEY_DOWN, KEY_LEFT, KEY_RIGHT;

	private static boolean controlBasClicked, controlDroiteClicked, controlGaucheClicked;
	private static ButtonGui controlBas, controlDroite, controlGauche;
