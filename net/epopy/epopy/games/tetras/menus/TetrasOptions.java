...
public class TetrasOptions extends AbstractGameMenu {
	...
	public void render() {
		...
		ComponentsHelper.drawText("Bas", 935, 370, PositionWidth.DROITE, PositionHeight.MILIEU, 30, color);
		ComponentsHelper.drawText("Gauche", 935, 550, PositionWidth.DROITE, PositionHeight.MILIEU, 30, color);
