...
public class TetrasGame extends AbstractGameMenu {
	...
	private boolean lastRotateL;
	private boolean lastRotateR;
	...
	public void onEnable() {
		...
		Random r = new Random();
		color = new float[] { r.nextFloat(), r.nextFloat(), r.nextFloat(), 1f };
		lastColor = new float[] { r.nextFloat(), r.nextFloat(), r.nextFloat(), 1f };
