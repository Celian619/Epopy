	...
	public void render() {
		...
		if (pauseScreen) {
			...
			if (pause.getTimePauseTotal() == 5) {
				...
				drawText("CONTROLES", x, y - 40, PositionWidth.MILIEU, PositionHeight.MILIEU, 30, new float[] { 1, 0.5f, 0, 1 });
				drawText("Droite", x - 80, y + 5, PositionWidth.MILIEU, PositionHeight.HAUT, 25, new float[] { 1, 1, 1, 1 });
				drawText("Gauche", x - 80, y + 150, PositionWidth.MILIEU, PositionHeight.HAUT, 25, new float[] { 1, 1, 1, 1 });

				renderTexture(Textures.GAME_TOUCHE_VIERGE, x - 30 - 80, y + 45, 60, 60);
				renderTexture(Textures.GAME_TOUCHE_VIERGE, x - 30 - 80, y + 150 + 35, 60, 60);
				drawText(Input.getKeyName(PlaceInvaderOptions.KEY_RIGHT), x - 28 - 80, y + 40, 50, new float[] { 0, 0, 0, 1 });
				drawText(Input.getKeyName(PlaceInvaderOptions.KEY_LEFT), x - 28 - 80, y + 150 + 30, 50, new float[] { 0, 0, 0, 1 });

				drawText("Tir", x + 80, y + 5, PositionWidth.MILIEU, PositionHeight.HAUT, 25, new float[] { 1, 1, 1, 1 });
				...
				drawText("Obtenir plus de", 710, 600, PositionWidth.MILIEU, PositionHeight.HAUT, 25, new float[] { 0.8f, 0.8f, 0.8f, 1 });
				drawText("100 points.", 710, 630, PositionWidth.MILIEU, PositionHeight.HAUT, 25, new float[] { 0.8f, 0.8f, 0.8f, 1 });
