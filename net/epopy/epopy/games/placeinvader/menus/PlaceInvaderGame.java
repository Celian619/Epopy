...
public class PlaceInvaderGame extends AbstractGameMenu {
	...
	private static final int robotSize = 80, playerSize = 70, yPlayer = defaultHeight - 100;
	private static int timer;

	private boolean playerShot, stats, pauseScreen;
	private int level, scoreLevel, score, life, shooted;
	private double xPlayer;
	private List<robot> robots;
	private List<Location> locBalleP, locBalleR;
