...
public class PlaceInvaderOptions extends AbstractGameMenu {
	...
	public void render() {
		...
		drawText("Gauche", 935, 738, PositionWidth.DROITE, PositionHeight.MILIEU, 30, color);
		drawText("Droite", 935, 370, PositionWidth.DROITE, PositionHeight.MILIEU, 30, color);
	}
}
