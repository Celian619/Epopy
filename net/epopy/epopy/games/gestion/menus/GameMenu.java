	...
	public void render() {
		...
		if (showStats) {
			...
			if (game != null) {
				...
				// temps
				int lastXTemps = ComponentsHelper.drawText("Temps de jeu", 780 - 10, 353, 30, new float[] { 1, 1, 1, 1 });
				...
				int lastXPartie = ComponentsHelper.drawText("Parties jouées", 770 - 10, 530, 30, new float[] { 1, 1, 1, 1 });
				...
				// dernier record
				int lastXRecord = ComponentsHelper.drawText("Record", 856 - 5, 718, 30, new float[] { 1, 1, 1, 1 });
