...
public class Textures {
	...
	private static List<Textures> textures = new ArrayList<Textures>(109);
	...
	public static Textures NETWORK_BOUTIQUE_TANK_CARROSSERIE = load("network/boutique/tank_carrosserie");
	public static Textures NETWORK_BOUTIQUE_TANK_CANON = load("network/boutique/tank_canon");
	public static Textures NETWORK_BOUTIQUE_TANK_MUNITIONS = load("network/boutique/tank_munitions");
	public static Textures NETWORK_BOUTIQUE_TANK_VITESSE = load("network/boutique/tank_vitesse");
	...
	public static Textures TETRAS_BGT = load("games/tetras/bgT");
	...
	// reflexion
	public static Textures REFLEXION_BG = load("games/reflexion/bg");
	public static Textures REFLEXION_DEMINEUR = load("games/reflexion/demineur");
	public static Textures REFLEXION_DEMINEUR_ON = load("games/reflexion/demineur_On");
	public static Textures REFLEXION_LARROW = load("games/reflexion/arrowL");
	public static Textures REFLEXION_LARROWFOCUS = load("games/reflexion/arrowLfocus");
	public static Textures REFLEXION_RARROW = load("games/reflexion/arrowR");
	public static Textures REFLEXION_RARROWFOCUS = load("games/reflexion/arrowRfocus");
	public static Textures REFLEXION_BOMB = load("games/reflexion/bomb");
	public static Textures REFLEXION_BOMB_EXPLODE = load("games/reflexion/bomb_explode");
