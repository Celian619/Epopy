...
public class Textures {
	...
	public static Textures GAME_MENU_USER_OFF = load("games/menu/user_off");
	public static Textures GAME_MENU_USER_ON = load("games/menu/user_on");
	...
	public void bind() {
		if (id == -12) {
			try {
				...
				buffer = BufferUtils.createIntBuffer(width * height * 4);
