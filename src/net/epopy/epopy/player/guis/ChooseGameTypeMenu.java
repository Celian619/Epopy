...
public class ChooseGameTypeMenu {
	...
	public ChooseGameTypeMenu() {
		...
		ButtonGui soloButton = new ButtonGui("SOLO", new float[]{ 1f,  1f, 1f, 1f}, 50, false);
		ButtonGui multiButton = new ButtonGui("MULTIJOUEUR", new float[]{1f, 1f, 1, 1}, 50, false);
		...
		while (true) {
			...
			if(Display.isCloseRequested()) 
				...
				//TODO	new RegisterPlayerNetworkMenu();
				//TODO break;	
