...
public class PlaceInvaderOptions extends AbstractGameMenu {
	...
	public static int KEY_LEFT = Integer.parseInt(Main.getPlayer().getConfig().getData("placeinvader_control_gauche", String.valueOf(Keyboard.KEY_LEFT)));
	public static int KEY_RIGHT = Integer.parseInt(Main.getPlayer().getConfig().getData("placeinvader_control_droite", String.valueOf(Keyboard.KEY_RIGHT)));
